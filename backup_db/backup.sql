...
2	pbkdf2_sha256$216000$nba2t6behJ6x$gq+GNXg9mbFliQeEJ2c/xn7W4ncYd6AUXP2qHvsNW1Q=	hang@gmail.com	Thắng Lê	456/17 Phú Thọ Hoà	Female	0123456789	2021-11-14 11:20:52.154628+07	2021-11-17 14:51:25.243671+07	t	t	t	f
1	pbkdf2_sha256$216000$OBAIkFwHQAFa$mhdq++Pn9L2ZCwCM5Gd9yUgrHsQIa9pLB70LCdzXenA=	nguyenlehuythang@gmail.com	Thang		Female	\N	2021-11-03 19:36:14.618625+07	2021-11-21 19:39:42.551636+07	t	t	t	t
\.
...
9	2021-11-17 13:34:56.478862+07	0		0	1
...
1	Adidas Hung Vuong	nhat@gmail.com	0123569845	456/17 Phú Thọ Hoà
\.
...
2b0hn5oq10s3345nw6w31ibvw2cmlgs2	.eJxVjLEOwiAURf-F2ZDyqFTc7O7oTB68V6mSkpQ2DsZ_lyYddLnDPffct3C4LtGthWc3kjgLJQ6_ncfw5GkD9MDpnmXI0zKPXm4TudMiLynlV41bdco1E6d-F__eIpZYr7jToQETGmVJU0vM4DUiWOtBWW6JtDr60NYBAYPt2CgcwskMoLTXJD5fY9Q9cw:1mom8E:rH8Goea70QE6kRkdoH4EhiRnc9Qx4MfrJNl6XGQ1GBw	2021-12-05 19:39:42.556637+07
\.
...
SELECT pg_catalog.setval('public."Users_account_groups_id_seq"', 6, true);
...
SELECT pg_catalog.setval('public."Users_account_id_seq"', 2, true);
...
SELECT pg_catalog.setval('public.app_for_user_bill_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.app_for_user_billdetail_id_seq', 16, true);
...
SELECT pg_catalog.setval('public.app_for_user_goodsreceipt_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.app_for_user_goodsreceiptdetail_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.app_for_user_stock_id_seq', 4, true);
...
CREATE UNIQUE INDEX billidx ON public.app_for_user_bill USING btree (state) WHERE ((state)::text = '0'::text);
